...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/13BDBD486B15C1C7FD2D8392FE5D62D5A5AC10D6-eclipselink.jar
	http://hg.netbeans.org/binaries/5282CF4CDBCD0210798283E0E35B3A1FDA994D37-hibernate-release-4.2.6-lib.zip
	...
	http://hg.netbeans.org/binaries/F83E685280F97AC09ACAFF71262C3718CDC98995-nb-javac-impl.jar
	http://hg.netbeans.org/binaries/7F267F8656463BCB6D7441D3F6436C8F516AC18C-org.eclipse.persistence.jpa.jpql_2.5.1.v20130918-f2b9fc5.jar
	http://hg.netbeans.org/binaries/C7526615424CD22908969630FD1D2B27818B6DCA-org.eclipse.persistence.jpa.modelgen_2.5.1.v20130918-f2b9fc5.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/13BDBD486B15C1C7FD2D8392FE5D62D5A5AC10D6-eclipselink.jar j2ee.eclipselink/external/eclipselink.jar || die
	ln -s "${DISTDIR}"/5282CF4CDBCD0210798283E0E35B3A1FDA994D37-hibernate-release-4.2.6-lib.zip hibernate4lib/external/hibernate-release-4.2.6-lib.zip || die
	...
	ln -s "${DISTDIR}"/F83E685280F97AC09ACAFF71262C3718CDC98995-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
	ln -s "${DISTDIR}"/7F267F8656463BCB6D7441D3F6436C8F516AC18C-org.eclipse.persistence.jpa.jpql_2.5.1.v20130918-f2b9fc5.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_2.5.1.v20130918-f2b9fc5.jar || die
	ln -s "${DISTDIR}"/C7526615424CD22908969630FD1D2B27818B6DCA-org.eclipse.persistence.jpa.modelgen_2.5.1.v20130918-f2b9fc5.jar j2ee.eclipselinkmodelgen/external/org.eclipse.persistence.jpa.modelgen_2.5.1.v20130918-f2b9fc5.jar || die
...
src_install() {
	...
	rm javassist-3.15.0-GA.jar && dosym /usr/share/javassist-3/lib/javassist.jar ${instdir}/javassist-3.15.0-GA.jar || die
	rm jboss-logging-3.1.0.GA.jar && dosym /usr/share/jboss-logging/lib/jboss-logging.jar ${instdir}/jboss-logging-3.1.0.GA.jar || die
	rm jboss-transaction-api_1.1_spec-1.0.1.Final.jar && dosym /usr/share/glassfish-transaction-api/lib/jta.jar ${instdir}/jboss-transaction-api_1.1_spec-1.0.1.Final.jar || die
	rm jtidy-r8-20060801.jar && dosym /usr/share/jtidy/lib/Tidy.jar ${instdir}/jtidy-r8-20060801.jar || die
	rm log4j-1.2.16.jar && dosym /usr/share/log4j/lib/log4j.jar ${instdir}/log4j-1.2.16.jar || die
	popd >/dev/null || die
