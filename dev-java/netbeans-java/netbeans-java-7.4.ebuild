...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/33693E782E0F99CA7E2DEECA0222F493EBB6BC82-eclipselink.jar
	...
	http://hg.netbeans.org/binaries/1FC667D74A0BB8B767F6974099F6C282C0D7EEBC-nb-javac-api.jar
	http://hg.netbeans.org/binaries/9B589FACB68780DCF96121A893F97307D47116DF-nb-javac-impl.jar
	http://hg.netbeans.org/binaries/B1D9BFCBC513472E819CB6C7E1018D26439D400A-org.eclipse.persistence.jpa.jpql_2.5.0.v20130507-3faac2b.jar
	http://hg.netbeans.org/binaries/BE675D922E5BFAF6557EB5E05A06B0B5047C08B1-org.eclipse.persistence.jpa.modelgen_2.5.0.v20130507-3faac2b.jar
	http://hg.netbeans.org/binaries/CB686A65B6C4516A32173CB60385D02027440620-spring-2.5.6.SEC03.jar
	http://hg.netbeans.org/binaries/60169962AA9DE533DE6298110E54880A1C8B0C01-spring-framework-3.2.3.RELEASE.zip"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/33693E782E0F99CA7E2DEECA0222F493EBB6BC82-eclipselink.jar j2ee.eclipselink/external/eclipselink.jar || die
	...
	ln -s "${DISTDIR}"/1FC667D74A0BB8B767F6974099F6C282C0D7EEBC-nb-javac-api.jar libs.javacapi/external/nb-javac-api.jar || die
	ln -s "${DISTDIR}"/9B589FACB68780DCF96121A893F97307D47116DF-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
	ln -s "${DISTDIR}"/B1D9BFCBC513472E819CB6C7E1018D26439D400A-org.eclipse.persistence.jpa.jpql_2.5.0.v20130507-3faac2b.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_2.5.0.v20130507-3faac2b.jar || die
	ln -s "${DISTDIR}"/BE675D922E5BFAF6557EB5E05A06B0B5047C08B1-org.eclipse.persistence.jpa.modelgen_2.5.0.v20130507-3faac2b.jar j2ee.eclipselinkmodelgen/external/org.eclipse.persistence.jpa.modelgen_2.5.0.v20130507-3faac2b.jar || die
	...
	ln -s "${DISTDIR}"/60169962AA9DE533DE6298110E54880A1C8B0C01-spring-framework-3.2.3.RELEASE.zip libs.springframework/external/spring-framework-3.2.3.RELEASE.zip || die
	popd >/dev/null || die
}
